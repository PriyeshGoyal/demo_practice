...
object DataFrameExm extends App{
  ...
  sparkConf.set("spark.app.name","DataFrameExm")
  ...
  val lines = spark.sparkContext.textFile("C:/Users/Lenovo/Desktop/Trendy tech/Sparkdepth/Spark_week11/orders_new.csv")
